...
#Implemented by Jared Rodrigues with Jellies implementation and bullet updates by Tiaan Mouton
...
class Barrier(GameObject):
    def __init__(self, position, size=0.7):
        ...
        self.size = size
        self.hitbox = load_sprite("Barrier0").get_width() / 3
...
class Bullets(GameObject):
    ...
    def __init__(self, position, velocity, angle, type=0):
        ...
        # load sprite based on type received
        if (type == 0): 
            ...
            self.damage = 1.5
            scale = 0.5
            self.hitbox = sprite.get_height() / 12
...
class Enemy(pygame.sprite.Sprite): # from alien
    def __init__(self,type,x,y):
        ...
        if type == 0: 
            ...
            self.hitbox = load_sprite("Ant").get_width() / 5
        elif type == 1: 
            self.hitpoints = 3
            self.hitbox = load_sprite("Bird").get_width() / 5
        else: 
            self.hitpoints = 50
